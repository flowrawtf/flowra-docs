...
icon: typography
order: 80
description: "Definitions of terms used throughout the Flowra documentation."
---
...
Auction tick
: One auction round in the Block Engine; several fit into each Solana slot. See [Auction Mechanics](../concepts/auction-mechanics.md).
...
State auction
: The contest among bundles whose account footprints overlap. Each tick resolves state auctions and assembles the winning batch from their winners.
